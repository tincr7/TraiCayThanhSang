...
public class Server {
    ...
    public static String Duongdansaurieng="http://" + localhost +":80/server/getsanpham.php?page=";
    ...
    public static String DuongdanDangNhap_User = "http://" + localhost +":80/server/dangnhap.php";
